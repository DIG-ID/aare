<header id="header-main" class="header-main absolute top-0 left-0 w-full z-50 overflow-hidden" itemscope itemtype="http://schema.org/WebSite">
	...
	<nav class="navbar relative overflow-hidden" role="navigation" aria-label="<?php esc_attr_e( 'Main menu', 'aare' ); ?>">
		<div class="header-wrapper relative grid grid-cols-3 px-6 xl:px-8 xl:px-16 py-6 xl:py-8 xl:py-6 z-40 border-b-[0.5px] border-blue-shade-2 border-opacity-80 xl:z-auto">
		...
		<div class="menu-app px-6 xl:px-8 xl:px-16 py-6 xl:py-8 xl:py-3 border-b-[0.5px] border-blue-shade-2 border-opacity-80 hidden xl:block">
			<?php
			wp_nav_menu(
				array(
