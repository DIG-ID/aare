<section class="section-amenities bg-blue-shade-1 pt-10">
	<div class="theme-container">
		<div class="theme-grid px-0 lg:px-6 xl:px-0 fade-in">
			...
			<div class="col-span-2 lg:col-span-4 col-start-1 lg:col-start-9">
				...
				<div class="note flex gap-x-2">
					...
					<p class="text-body text-blue-shade-5"><?php the_field( 'single_zimmer_breakfast_note', 'options' ); ?></p>
				</div>
			</div>
		</div>
		<span class="w-full h-[1px] bg-blue-shade-3 block mt-20 fade-in"></span>
		<div class="back-to-archive flex items-center gap-x-2 pt-4 pb-20 fade-in">
			...
			<a class="font-poppins font-semibold text-sm text-blue-shade-3 tracking-[0.14px] uppercase" href="<?php echo esc_url( get_post_type_archive_link( 'zimmer' ) ); ?>"><?php esc_html_e( 'Zurück zu den zimmern', 'baeren' ); ?></a>
		</div>
