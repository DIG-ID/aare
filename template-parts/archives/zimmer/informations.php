<section class="section-zimmer-archive-info relative bg-blue-shade-3 lg:bg-white lg:pb-52">
	<div class="theme-container">
		<div class="theme-grid">
			<div class="zimmer-info col-span-2 lg:col-span-12 bg-blue-shade-3 flex flex-col lg:flex-row lg:justify-between lg:rounded-[20px] pt-14 pb-20 lg:pt-24 lg:pb-16 lg:px-28">
				...
				<div class="w-full mt-10 lg:mt-0">
					<div class="flex flex-col items-center lg:items-start mb-16">
						<h2 class="text-title-h2 text-blue-shade-1 mb-8 lg:mb-10 text-center lg:text-left"><?php the_field( 'archive_zimmer_info_services_title', 'options' ); ?></h2>
						<p class="text-body text-blue-shade-1 w-full lg:w-3/5 mb-9 text-center lg:text-left"><?php the_field( 'archive_zimmer_info_services_description', 'options' ); ?></p>
						<?php
					...
					<div class="flex flex-col items-center lg:items-start">
						<h2 class="text-title-h2 text-blue-shade-1 mb-8 lg:mb-10 text-center lg:text-left"><?php the_field( 'archive_zimmer_info_sustainability_title', 'options' ); ?></h2>
						<p class="text-body text-blue-shade-1 w-full lg:w-3/5 mb-9 text-center lg:text-left"><?php the_field( 'archive_zimmer_info_sustainability_description', 'options' ); ?></p>
						<?php
