<section class="section-testimonials bg-blue-shade-3 pt-24 pb-28 relative overflow-hidden">
    <div class="theme-container">
        <div class="theme-grid">
            <div class="col-span-2 lg:col-span-12 lg:pb-20">
                <h2 class="font-miller font-light text-2xl xl:text-5xl leading-7 w-[40%] xl:w-full mx-auto xl:mx-0 text-blue-shade-2 text-center"><?php echo get_field( 'testimonials_title' ); ?></h2>
            </div>
            <div class="col-span-2 lg:col-span-10 lg:col-start-2 grid grid-cols-2 lg:grid-cols-10 gap-x-6">
                ...
                while( have_rows('testimonials_list') ) : the_row(); ?>
                    <div class="testimonials-box col-span-2 lg:col-span-5 rounded-[22px] bg-blue-shade-1">
                        <div class="py-16 lg:px-24">
