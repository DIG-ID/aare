<section class="section-history-hospital relative overflow-hidden">
    <div class="history-hospital py-12 relative pr-20">    
        <div class="h-[90vh] w-[6000px] grid grid-cols-10 my-auto">
            ...
            <div class="col-span-1 pt-20 bg-blue-shade-1 lg:-ml-[2px] relative">
                ...
                if ( $himage1 ) :
                    echo wp_get_attachment_image( $himage1, 'full', false, array( 'class' => 'w-full object-cover rounded-[24px] lg:max-w-[650px] lg:min-w-[650px] lg:-mt-[20%] lg:-ml-[18%] lg:mb-[7%]' ) );
                endif;
                ?>
            ...
            <?php
                ...
                if ( $himage3 ) :
                    echo wp_get_attachment_image( $himage3, 'full', false, array( 'class' => 'w-full object-cover rounded-[24px] mx-auto lg:max-w-[520px] mb-10 lg:mb-[9%] lg:-mt-[20%]' ) );
                endif;
                ?>
                <?php
