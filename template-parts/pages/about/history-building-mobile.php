<section class="section-history-building bg-blue-shade-5 relative overflow-hidden block xl:hidden pb-28">
    <div class="theme-container">
        <div class="theme-grid">
            <div class="col-span-2 px-8 py-7 bg-blue-shade-1 rounded-t-[24px] relative">
            ...
            <div class="col-span-2 px-8 py-7 bg-blue-shade-1 relative">
            ...
            <div class="col-span-2 px-8 py-7 bg-blue-shade-1 rounded-b-[24px] relative">
