<section class="section-media-corner-content py-28">
	<div class="theme-container">
		<div class="theme-grid">
				...
				if ( have_rows( 'releases' ) ) :
					while ( have_rows( 'releases' ) ) :
						...
						<div class="card-media mb-8 lg:mb-16">
							...
							<a href="<?php echo esc_html( get_sub_field( 'link' ) ); ?>" target="_blank"><h3 class="text-title-h3 text-blue-shade-5 underline"><?php the_sub_field( 'title' ); ?></h3></a>
						</div>
						<?php
					endwhile;
				endif;
			...
			<h2 class="text-title-h2 text-blue-shade-5 mb-10 mt-10 lg:mt-0 lg:mb-16"><?php the_field( 'results_title' ); ?></h2>
				<?php
