<section class="section-arrival-contact-content">
	<div class="theme-container">
		<div class="flex flex-col flex-wrap lg:h-[1900px] gap-6">
			<div class="address w-1/2 bg-white px-8 lg:px-28 pt-9 lg:pt-14 pb-14 lg:pb-28 rounded-[20px] overflow-hidden order-1 lg:order-1">
				<img class="mb-16" src="<?php echo esc_url( get_theme_file_uri( '/assets/images/boat.png' ) ); ?>" alt="boat">
				<p class="text-body--serif text-blue-shade-5 mb-8"><?php the_field( 'address_address' ); ?></p>
				<?php
				$phone = get_field( 'address_phone' );
				if ( $phone ) :
					?>
					<p class="text-body--serif text-blue-shade-5 mb-8">
			...
			<div class="arrival-by-auto w-1/2 bg-white rounded-[20px] overflow-hidden order-4 lg:order-2">
				<?php
			...
			<div class="arrival-by-zug w-1/2 bg-white rounded-[20px] overflow-hidden order-5 lg:order-3">
				<?php
			...
			<div class="contact-form w-1/2 bg-white px-8 lg:px-20 pt-12 lg:pt-14 pb-14 lg:pb-28 rounded-[20px] overflow-hidden order-2 lg:order-4">
			...
			<div class="map w-1/2 bg-white rounded-[20px] overflow-hidden order-3 lg:order-5 min-h-[614px]">
				<?php
			...
			<div class="arrival-by-bus w-1/2 bg-white rounded-[20px] overflow-hidden order-6 lg:order-6">
				<?php
