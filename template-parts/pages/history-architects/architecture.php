<section class="section-architecture bg-blue-shade-4 pb-28 xl:pb-52 pt-16">
	<div class="theme-container">
		<div class="theme-grid">
			<div class="col-span-2 lg:col-start-2 lg:col-span-10 grid grid-cols-2 lg:grid-cols-10">
				...
				<div class="col-span-2 lg:col-span-4 lg:col-start-2 lg:mb-40 order-2 xl:order-2">
					<?php
				...
				<div class="col-span-2 pt-20 lg:pt-0 lg:col-span-4 lg:col-start-8 order-4 xl:order-5">
					<?php
