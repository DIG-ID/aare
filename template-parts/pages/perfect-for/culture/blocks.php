<section class="section-culture-blocks bg-white pt-6 lg:pt-40">
			...
			if ( have_rows( 'blocks' ) ) :
				while ( have_rows( 'blocks' ) ) :
					...
					<div class="card-perfect-for--culture grid grid-cols-2 lg:grid-cols-12 lg:grid-rows-1 col-span-2 lg:col-span-12 gap-x-6 mb-8 lg:mb-28">
						<div class="card-perfect-for---culture-content col-span-2 lg:col-span-7 lg:col-start-1 py-7 lg:py-14 px-9 lg:px-28 bg-purple-shade-1 rounded-[20px] lg:row-span-full relative z-20 flex flex-col justify-center order-2 lg:order-1">
						...
						<div class="card-perfect-for---culture-image col-span-2 lg:col-start-6 lg:col-end-13 lg:col-span-6 relative lg:z-10 lg:row-span-full order-1 lg:order-2">
							<?php
