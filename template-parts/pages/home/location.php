<section class="section-location bg-blue-shade-5 pt-20 pb-28 relative overflow-hidden">
    <div class="theme-container grid grid-cols-2 xl:grid-cols-12 gap-x-6">
        <div class="col-span-2 xl:col-span-2 col-start-1 xl:col-start-4">
            <?php
        ...
        <div class="col-span-2 xl:col-span-3 col-start-1 xl:col-start-6 flex flex-col justify-between xl:pl-7">
            <p class="text-title-h3 text-blue-shade-2"><?php echo get_field( 'location_text' ); ?></p>
            <?php 
