<section class="section-intro bg-blue-shade-1 pt-0 pb-0 relative overflow-hidden">
    <div class="theme-container grid xl:grid-cols-12 gap-x-6">
        <div class="xl:col-span-12 text-center pt-12">
    ...
    <div class="theme-container grid xl:grid-cols-12 gap-x-6 pt-32">
        <div class="xl:col-span-5 col-start-1 xl:col-start-2">
        ...
        <div class="xl:col-span-5 col-start-1 xl:col-start-7 mt-28">
        <?php 
    ...
    <div class="theme-container grid xl:grid-cols-12 gap-x-6 xl:pt-40 xl:pb-32">
        <div class="xl:col-span-4 col-start-1 xl:col-start-2">
        <?php 
        ...
        <div class="xl:col-span-5 col-start-1 xl:col-start-7 mt-28 flex items-end">
